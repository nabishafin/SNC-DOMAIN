...
export const baseApi = createApi({
  ...
  tagTypes: ["auth", "dashboardStats", "admin-users", "earnings-overview", "Faqs", "payments", "domains", "dns", "ssl", "contacts", "dnssec", "dnssec-keys", "glueRecords", "zones", "zone-records", "ns-sets"],
  endpoints: () => ({}),
