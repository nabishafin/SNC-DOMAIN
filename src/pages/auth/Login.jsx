...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log('Token from response:', result?.token);
            console.log('User from response:', result?.user);

            // Check if login was successful
            if (result?.success && result?.token) {
                // Manually dispatch setLogin to save token and user to Redux + localStorage
                dispatch(setLogin({
                    user: result.user,
                    token: result.token,
            ...
            toast.error(error?.data?.message || 'Login Failed. Please check your email and password.');
        }
    };
