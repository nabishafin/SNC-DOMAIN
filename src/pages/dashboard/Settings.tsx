...
const Settings = () => {
    ...
    const tabs = [
        { id: 'profile' as const, label: 'Profile', icon: User, desc: 'Manage your personal info' },
        { id: 'security' as const, label: 'Security', icon: Lock, desc: 'Password and 2FA' },
        { id: 'notifications' as const, label: 'Notifications', icon: Bell, desc: 'Email preferences' },
    ];

    const handleProfileSubmit = (e: FormEvent) => {
        e.preventDefault();
        addToast('success', 'Profile Updated', 'Your specific profile information has been saved.');
    };
