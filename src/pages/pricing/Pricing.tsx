...
const Pricing = () => {
    const [selectedCategory, setSelectedCategory] = useState<'all' | 'generic' | 'country' | 'new'>(
        'all'
    );

    const categories = [
        { id: 'all' as const, label: 'All TLDs' },
        { id: 'generic' as const, label: 'Generic (.com, .net, .org)' },
        { id: 'country' as const, label: 'Country Code (.io, .co, .ai)' },
        { id: 'new' as const, label: 'New TLDs (.app, .dev, .tech)' },
    ];
